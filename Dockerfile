...
RUN apk add --no-cache --virtual .build-deps curl ca-certificates \
 ...
 && rm -rf /frp* frp*
CMD ["/usr/bin/frps", "--token=frp888 --vhost_http_port=80 --vhost_https_port=443 --dashboard_port=7500 --allow_ports=10000-20000 --subdomain_host=vipxkw.usw1.kubesail.org"]
